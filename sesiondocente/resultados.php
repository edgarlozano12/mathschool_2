...
<?php
  ...
  $check_docu_query="select * from docente WHERE usuario='$user_name'";
...
<div id="wrapper">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index_docente.php"><span>M</span>ath School</a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index_docente.php">Inicio</a></li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <b class="fa fa-user"></b><span><?php echo $_SESSION['docente']; ?></span>
    		                  </a>
    		                  <ul class="dropdown-menu">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					<li><a href="index_docente.php"><i class="fa fa-home"></i></a><i class="icon-angle-right"></i></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">RESULTADOS:</h4>
                <div class="row">
                    <section id="projects">
                    <ul id="thumbs" class="portfolio">
                        <!-- Item Project and Filter Name -->
                        <li class="col-lg-3 design" data-id="id-0" data-type="unidad1">
                        <div class="item-thumbs">
                        <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                        <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 1" href="unidades/unidad1/unidad1.html">
                        <span class="overlay-img"></span>
                        <span class="overlay-img-thumb font-icon-plus"></span>
                        </a>
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad1.png" alt="unidad 1">
            						<center><img src="../img/unidades/uno.gif" alt="unidad 1"></center>
                        ...
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
                        <li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="unidad2">
                        <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                        <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 2" href="unidades/unidad2/unidad2.html">
                        <span class="overlay-img"></span>
                        <span class="overlay-img-thumb font-icon-plus"></span>
                        </a>
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad2.png" alt="unidad 2">
            						<center><img src="../img/unidades/dos.gif" alt="unidad 2"></center>
                        </li>
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
                        <li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="unidad3">
                        <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                        <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 3" href="unidades/unidad3/unidad3.html">
                        <span class="overlay-img"></span>
                        <span class="overlay-img-thumb font-icon-plus"></span>
                        </a>
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad3.png" alt="unidad 3">
            						<center><img src="../img/unidades/tres.gif" alt="unidad 3"></center>
                        </li>
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
                        <li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="illustrator">
                        <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                        <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 4" href="unidades/unidad4unidad4.html">
                        <span class="overlay-img"></span>
                        <span class="overlay-img-thumb font-icon-plus"></span>
                        </a>
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad4.png" alt="unidad 4">
            						<center><img src="../img/unidades/cuatro.gif" alt="unidad 4"></center>
                        </li>
                        <!-- End Item Project -->
                    </ul>
                    </section>

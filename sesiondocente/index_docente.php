...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="../img/slides/b_docente.jpg" alt="" />
              </li>
              <li>
                <img src="../img/slides/resultados.jpg" alt="" />
                <div class="flex-caption">
                    <h3>RESULTADOS</h3>
					<p>Conoce los resultados de los estudiantes...</p>
					<a href="resultados.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
              <li>
                <img src="../img/slides/estudiantes.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Estudiantes</h3>
					<p>Conoce el listado de estudiantes....</p>
					<a href="estudiantes.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
              <li>
                <img src="../img/slides/estadistica.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Estadistica</h3>
					<p>Conoce toda la estadistica de las actividades...</p>
					<a href="estadisticas.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="RESULTADOS" href="resultados.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/resultados.jpg" alt="RESULTADOS">
						</div>
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="ESTUDIANTES" href="estudiantes.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/estudiantes.jpg" alt="ESTUDIANTES">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="unidad3">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="ESTADISTICAS" href="estadisticas.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/estadisticas.jpg" alt="ESTADISTICA">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<!-- End Item Project -->

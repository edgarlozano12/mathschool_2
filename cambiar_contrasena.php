        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><span>M</span>ath School</a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.html">Inicio</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Nuestro Proyecto <b class=" icon-angle-down"></b></a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="./unidades/unidad1/unidad1.html">Unidad 1</a></li>
                                <li><a href="./unidades/unidad2/unidad2.html">Unidad 2</a></li>
                                <li><a href="./unidades/unidad3/unidad3.html">Unidad 3</a></li>
                                <li><a href="./unidades/unidad4/unidad4.html">Unidad 4</a></li>
                            </ul>
                        </li>
			...
			<div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
					<div class="login-panel panel panel-success">
							...
							<div class="panel-body">
									<form role="form" method="post" action="actualizar_contrasena.php">
																			<fieldset>
																					<div class="form-group">
																							<select class="form-control" placeholder="opcion" name="opcion" type="select" value="">
																					...
																					<div class="form-group">
																							<input class="form-control" placeholder="No de Identificacion" name="identificacion" type="text" value="">
																					</div>
																					<div class="form-group">
																							<input class="form-control" placeholder="Usuario" name="usuario" type="text" value="">
																					</div>
																					<div class="form-group">
																							<input class="form-control" placeholder="Contraseña Nueva" name="pass1" type="password" value="">
																					</div>
																					<div class="form-group">
																					...
																					<input class="btn btn-lg btn-success btn-block" type="submit" value="Cambiar" name="register" >
																			</fieldset>
																	</form>

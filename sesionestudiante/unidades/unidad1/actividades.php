			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="SUMA" href="../../unidades/unidad1/actividades/union/mat/juego 1.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../../../img/unidades/actividad 1.jpg" alt="contenido " >
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="RESTA" href="../../unidades/unidad1/actividades/crear/suma/suma.htm">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../../../img/unidades/actividad 2.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="multiplicacion">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="MULTIPLICACION" href="../../unidades/unidad1/actividades/ahorcado/ahorcado/aho/juego 1.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../../../img/unidades/actividad 3.jpg" alt=" ">
						</li>
					</ul>
					</section>
				</div>

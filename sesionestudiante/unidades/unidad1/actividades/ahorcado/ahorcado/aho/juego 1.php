		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="../../../../../unidad1/unidad1.php">Unidad 1</a><i class="icon-angle-right"></i></li>
					...
					<li class="active">Actividad 3</li>
				</ul>
			</div>
		</div>
	</div>
...
<link type="text/css" href="aho_resources/css/ardoraAfor.css" rel="stylesheet" />
...
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraAforCFG.js"></script>
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraScorm.js"></script>
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraAfor.js"></script>
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraCanvasDraw.js"></script>
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraTab.js"></script>
<script language="javascript" type="text/javascript" src="aho_resources/js/ardoraPosts.js"></script>
</head>
<body onLoad="loadPage()" onbeforeunload="unloadPage()" onUnload="unloadPage()">
<div id="ardoraMain">
<audio id="audioFelicitacion">
<source src="aho_resources/media/Aplausos___Efectos_de_Sonido_1_.mp3" type="audio/mp3">
</audio>
<audio id="audioTempo">
<source src="aho_resources/media/trompeta_perdedor_6_.mp3" type="audio/mp3">
</audio>
...
<audio id="audioMQ">
<source src="aho_resources/media/3x2.mp3" type="audio/mp3">
</audio>
<audio id="audioMg">
<source src="aho_resources/media/2x2.mp3" type="audio/mp3">
</audio>
<audio id="audioMw">
<source src="aho_resources/media/4X3.mp3" type="audio/mp3">
</audio>
<div id="ardoraEnu"><br>
</span></div>
  <div id="ardoraAct">

	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div>
				<center><H1>LA SUMA</H1></center>
				<justify><FONT FACE="arial" SIZE=5 COLOR=BLUE>La adición es una operación de numeros naturales que sirve para resolver situaciones concretas. Las cantidades que se suman se llaman SUMANDOS y el resultado, SUMA o TOTAL</FONT></justify>
				<center><img src="../../../img/unidades/terminos de la suma.jpg"></center>
				</div>
				<div class="row">
					<section id="projects">
					<justify><FONT FACE="arial" SIZE=5 COLOR=red>EJEMPLOS:</FONT></justify>
					<ul id="thumbs" class="portfolio">
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="ejemplo_1">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="EJEMPLO 1" href="s_ejemplo_1.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../../../img/unidades/ejemplo_1.jpg" alt="EJEMPLO 1" >
						</li>
					</ul>
					</section>
				</div>
				<div class="row">
					...
					<justify><FONT FACE="arial" SIZE=5 COLOR=red>VIDEOS:</FONT></justify>
						<table border="0" style="width:80%">
							<tr>
							<td><object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/7gYzNGlsFcc"></param><embed src="http://www.youtube.com/v/7gYzNGlsFcc" type="application/x-shockwave-flash" width="425" height="350"></embed></object></td>

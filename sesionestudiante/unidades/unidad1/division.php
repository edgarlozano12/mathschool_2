		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="tema1"><a href="#" title="">La división y sus términos</a></li>
					<li class="tema2"><a href="#" title="">División exacta y División inexacta</a></li>
					<li class="tema3"><a href="#" title="">Divisor de una cifra</a></li>
					<li class="tema4"><a href="#" title="">Divisiones con ceros en el dividendo </a></li>
					<li class="tema5"><a href="#" title="">Divisiones con ceros en el cociente</a></li>
					<li class="tema6"><a href="#" title="">Divisor de dos cifras</a></li>
					<li class="tema7"><a href="#" title="">Divisores de un numero</a></li>
					<li class="tema8"><a href="#" title="">Números primos y Números compuestos</a></li>
					<li class="tema9"><a href="#" title="">Criterios de divisibilidad</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="La división y sus términos" href="../../../img/works/1.jpg">
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="División exacta y División inexacta" href="../../../img/works/2.jpg" </ul>>
						<span class="overlay-img"></span>
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Divisor de una cifra" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Divisiones con ceros en el dividendo " href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Divisiones con ceros en el cociente" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Divisor de dos cifras" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Divisores de un numero" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Números primos y Números compuestos" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Criterios de divisibilidad" href="../../../img/works/3.jpg">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->

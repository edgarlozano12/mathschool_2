		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="tema2"><a href="#" title="">Adición de números naturales</a></li>
					<li class="tema3"><a href="#" title="">Propiedades de la adición</a></li>
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Definición" href="teoria_suma.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../../../img/unidades/definicion.jpg" alt=" " >
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Adición de números naturales" href="actividades.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../../../img/unidades/propiedades_suma.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="tema3">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Propiedades de la adición" href="actividades.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../../../img/unidades/actividades.jpg" alt=" ">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->

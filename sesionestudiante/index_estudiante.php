...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="../img/slides/b_estudiante.jpg" alt="" />
              </li>
              <li>
                <img src="../img/slides/unidades.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Conoce Nuestras Unidades</h3> 
					<p>Math School cuenta con 4 unidades...</p> 
					<a href="unidades.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
              <li>
                <img src="../img/slides/unidad 1.jpg" alt="" />
                <div class="flex-caption">
                    <h3>UNIDAD 1</h3> 
					<p>La unidad 1 cuenta con los temas suma, resta, multiplicacion y division....</p> 
					<a href="./unidades/unidad1/unidad1.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 1" href="unidades/unidad1/unidad1.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/unidad 1.jpg" alt="unidad 1">
						</div>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 2" href="unidades/unidad2/unidad2.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/unidad 2.jpg" alt="En Proceso..">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="unidad3">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 3" href="unidades/unidad3/unidad3.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/unidad 3.jpg" alt="En Proceso..">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="unidad4">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 4" href="unidades/unidad4/unidad4.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/unidad 4.jpg" alt="En proceso..">
						</li>
						<!-- End Item Project -->
					</ul>
					</section>

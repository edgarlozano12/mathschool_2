...
<link href="../ss/fancybox/jquery.fancybox.css" rel="stylesheet">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="unidad1"><a href="#" title="">Unidad 1</a></li>
					<li class="unidad2"><a href="#" title="">Unidad 2</a></li>
					<li class="unidad3"><a href="#" title="">Unidad 3</a></li>
					<li class="unidad4"><a href="#" title="">Unidad 4</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="unidad1">
						...
						<img  src="../img/unidades/unidad 1.jpg" alt="contenido " >
						...
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="unidad4">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Unidad 4" href="unidades/unidad4f/unidad4.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->

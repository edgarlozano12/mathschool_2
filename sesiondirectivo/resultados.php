            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <ul id="thumbs" class="portfolio">
                        ...
                        <img src="../img/unidades/uno.gif" alt="unidad 1">
                        </div>
                        ...
                        <img src="../img/unidades/dos.gif" alt="unidad 2">
                        </li>
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
                        ...
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad3.png" alt="En Proceso..">
                        <img src="../img/unidades/tres.gif" alt="unidad 3">
                        </li>
                        <!-- End Item Project -->
                        <!-- Item Project and Filter Name -->
                        ...
                        <!-- Thumb Image and Description -->
                        <img src="../img/unidades/unidad4.png" alt="En proceso..">
                        <img src="../img/unidades/cuatro.gif" alt="unidad 4">
                        </li>
                        <!-- End Item Project -->
                    </ul>
                    </section>

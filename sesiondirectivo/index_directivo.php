...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="../img/slides/b_directivo.jpg" alt="" />
              </li>
              <li>
                <img src="../img/slides/2.jpg" alt="" />
                <div class="flex-caption">
                    <h3>¿QUIENES SOMOS?</h3>
					<p>Math School es un recurso educativo digital que busca...</p>
					<a href="quienessomos.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>
              <li>
                ...
                <div class="flex-caption">
                    <h3>TEMAS</h3>
					<p>Conoce los temas que ofrece Math School....</p>
					<a href="temas_doc.php" class="btn btn-theme">Ver Mas</a>
                </div>
              </li>

            ...
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="usuarios.php">Usuarios</a><i class="icon-angle-right"></i></li>
                     <li><a href="administrador.php">Administrador</a><i class="icon-angle-right"></i></li>
                    <li class="active">Eliminar Administrador</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->
    ...
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
        ...
        $view_users_query="select * from administrador";//select query for viewing users.
...
<!--here showing results in the table -->
            <td><a href="fun_eliminar_administrador.php?del=<?php echo $user_codigo ?>"><button class="btn btn-danger">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->

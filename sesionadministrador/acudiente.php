		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="ver_acudiente"><a href="#" title="">Ver Acudiente</a></li>
					<li class="insertar_acudiente"><a href="#" title="">Agregar Acudiente</a></li>
					<li class="eliminar_acudiente"><a href="#" title="">Eliminar Acudiente</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="ver_acudiente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Ver Acudiente" href="ver_acudiente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/ver_usuario.jpg" alt="VER ACUDIENTE" >
						<center><FONT FACE="arial" size="5" COLOR=red>VER ACUDIENTES</FONT></center>
						</li>

						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="insertar_acudiente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Agregar Acudiente" href="ingresar_acudiente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/agregar_usuario.jpg" alt="AGREGAR ACUDIENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>AGREGAR ACUDIENTE</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="eliminar_acudiente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Eliminar Acudiente" href="eliminar_acudiente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/eliminar_usuario.jpg" alt="ELIMINAR ACUDIENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>ELIMINAR ACUDIENTES</FONT></center>
						</li>
					</section>
				</div>
			</div>

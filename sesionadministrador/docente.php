		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="ver_docente"><a href="#" title="">Ver Docente</a></li>
					<li class="insertar_docente"><a href="#" title="">Insertar Docente</a></li>
					<li class="eliminar_docente"><a href="#" title="">Eliminar Docente</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="ver_docente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Ver Docente" href="ver_docente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/ver_usuario.jpg" alt="VER DOCENTE" >
						<center><FONT FACE="arial" size="5" COLOR=red>VER DOCENTES</FONT></center>
						</li>

						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="insertar_docente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Insertar Docente" href="ingresar_docente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/agregar_usuario.jpg" alt="AGREGAR DOCENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>AGREGAR DOCENTES</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="eliminar_docente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Eliminar Docente" href="eliminar_docente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/eliminar_usuario.jpg" alt="ELIMINAR DOCENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>ELIMINAR DOCENTES</FONT></center>
						</li>
					</section>
				</div>
			</div>

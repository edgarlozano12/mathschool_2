            ...
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="usuarios.php">Usuarios</a><i class="icon-angle-right"></i></li>
                     <li><a href="acudiente.php">Acudiente</a><i class="icon-angle-right"></i></li>
                    <li class="active">Eliminar Acudiente</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->
    ...
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
        ...
        $view_users_query="select * from acudiente";//select query for viewing users.
...
<!--here showing results in the table -->
            <td><a href="fun_eliminar_acudiente.php?del=<?php echo $user_codigo ?>"><button class="btn btn-danger">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->

		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="ver_estudiante"><a href="#" title="">Ver Estudiantes</a></li>
					<li class="insertar_estudiante"><a href="#" title="">Insertar Estudiantes</a></li>
					<li class="eliminar_estudiante"><a href="#" title="">Eliminar Estudiantes</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="ver_estudiante">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Ver Estudiante" href="ver_estudiantes.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/ver_usuario.jpg" alt="VER ESTUDIANTE" >
						<center><FONT FACE="arial" size="5" COLOR=red>VER ESTUDIANTES</FONT></center>
						</li>

						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="insertar_estudiante">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Insertar Estudiante" href="ingresar_estudiantes.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/agregar_usuario.jpg" alt="AGREGAR ESTUDIANTE">
						<center><FONT FACE="arial" size="5" COLOR=red>AGREGAR ESTUDIANTES</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="eliminar_estudiante">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Eliminar Estudiante" href="eliminar_estudiante.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/eliminar_usuario.jpg" alt="ELIMINAR ESTUDIANTE">
						<center><FONT FACE="arial" size="5" COLOR=red>ELIMINAR ESTUDIANTES</FONT></center>
						</li>
					</section>
				</div>
			</div>

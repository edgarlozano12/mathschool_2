...
$cone=mysqli_connect("localhost","root","") or
//$cone=mysqli_connect("sql203.260mb.net","n260m_16595378","nvfsr5cg") or
die("No se puede conectar");
mysqli_select_db($cone,"mathschool") or
//mysqli_select_db($cone,"n260m_16595378_mathschool") or
...
<div id="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="estudiantes.php">Estudiantes</a><i class="icon-angle-right"></i></li>
                    <li class="active">Ingresar Estudiantes</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section>
        ...
        <h1 align="center">INGRESAR ESTUDIANTE</h1>
        ...
        <div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
            <div class="login-panel panel panel-success">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="regis_estudiante.php">
                                        <fieldset>

                                            <div class="form-group">
                                                <select class="form-control" placeholder="tipo" name="estudiante" type="select" value="" autofocus>
                                                        <option value="" selected>Elige un acudiente</option>

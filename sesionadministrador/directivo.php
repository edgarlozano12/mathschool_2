		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="ver_directivo"><a href="#" title="">Ver Directivo</a></li>
					<li class="insertar_directivo"><a href="#" title="">Agregar Directivo</a></li>
					<li class="eliminar_directivo"><a href="#" title="">Eliminar Directivo</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="ver_directivo">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Ver Directivo" href="ver_directivo.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>s
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/ver_usuario.jpg" alt="VER DIRECTIVO" >
						<center><FONT FACE="arial" size="5" COLOR=red>VER DIRECTIVOS</FONT></center>
						</li>

						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="insertar_directivo">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Insertar Directivo" href="ingresar_directivo.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/agregar_usuario.jpg" alt="AGREGAR DIRECTIVO">
						<center><FONT FACE="arial" size="5" COLOR=red>AGREGAR DIRECTIVO</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="eliminar_directivo">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Eliminar Directivo" href="eliminar_directivo.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/eliminar_usuario.jpg" alt="ELIMINAR DIRECTIVO">
						<center><FONT FACE="arial" size="5" COLOR=red>ELIMINAR DIRECTIVOS</FONT></center>
						</li>
					</section>
				</div>
			</div>

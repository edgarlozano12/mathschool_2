...
<div id="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="estudiantes.php">Acudiente</a><i class="icon-angle-right"></i></li>
                    <li class="active">Ingresar Acudiente</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section>
        ...
        <h1 align="center">INGRESAR ACUDIENTE</h1>
        ...
        <div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
            <div class="login-panel panel panel-success">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="regis_acudiente.php">
                                        <fieldset>

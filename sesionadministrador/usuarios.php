		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="portfolio-categ filter">
					...
					<li class="estudiante"><a href="#" title="">Estudiante</a></li>
					<li class="docente"><a href="#" title="">Docente</a></li>
					<li class="acudiente"><a href="#" title="">Acudiente</a></li>
					<li class="directivo"><a href="#" title="">Directivo</a></li>
					<li class="administrador"><a href="#" title="">Administrador</a></li>
				</ul>
				<div class="clearfix">
				</div>
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="estudiante">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="ESTUDIANTE" href="estudiantes.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<img  src="../img/unidades/u_estudiante.jpg" alt="ESTUDIANTE">
						<center><FONT FACE="arial" size="5" COLOR=red>ESTUDIANTE</FONT></center>
						</li>


						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="docente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="DOCENTE" href="docente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/u_docente.jpg" alt="DOCENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>DOCENTE</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="acudiente">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="ACUDIENTE" href="acudiente.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img  src="../img/unidades/u_acudiente.jpg" alt="ACUDIENTE">
						<center><FONT FACE="arial" size="5" COLOR=red>ACUDIENTE</FONT></center>
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="directivo">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="DIRECTIVO" href="directivo.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/u_directivo.jpg" alt="DIRECTIVO">
						<center><FONT FACE="arial" size="5" COLOR=red>DIRECTIVO</FONT></center>
						</li>
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="administrador">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="ADMINISTRADOR" href="administrador.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/u_acudiente.jpg" alt="ADMINISTRADOR">
						<center><FONT FACE="arial" size="5" COLOR=red>ADMINISTRADOR</FONT></center>
						</li>
					</ul>
					</section>
				</div>

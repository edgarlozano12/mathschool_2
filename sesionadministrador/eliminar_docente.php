            ...
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="usuarios.php">Usuarios</a><i class="icon-angle-right"></i></li>
                     <li><a href="docente.php">Docente</a><i class="icon-angle-right"></i></li>
                    <li class="active">Eliminar Docente</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->
    ...
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
        ...
        <tr>
            ...
            <th>USUARIO</th>
            <th>CLAVE</th>
            <th>ELIMINAR DOCENTE</th>
        </tr>
        </thead>

        <?php
        include("../database/db_conection.php");
        $view_users_query="select * from docente";//select query for viewing users.
...
<!--here showing results in the table -->
            ...
            <td><?php echo $user_grado;  ?></td>
            <td><?php echo $user_usuario;  ?></td>
            <td><?php echo $user_clave;  ?></td>
            <td><a href="fun_eliminar_docente.php?del=<?php echo $user_codigo ?>"><button class="btn btn-danger">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->
        </tr>

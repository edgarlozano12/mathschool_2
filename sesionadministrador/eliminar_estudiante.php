        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Eliminar Estudiante</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->
    ...
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
        ...
        $view_users_query="select * from estudiante";//select query for viewing users.
...
<!--here showing results in the table -->
            <td><a href="fun_eliminar_estudiantes.php?del=<?php echo $user_codigo ?>"><button class="btn btn-danger">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->

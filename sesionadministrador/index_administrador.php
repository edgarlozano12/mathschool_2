...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="../img/slides/b_admin.jpg" alt="" />
              </li>
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<center>
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="VER USUARIOS" href="usuarios.php">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb font-icon-plus"></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="../img/unidades/usuarios.jpg" alt="VER USUARIOS">
						</center>
						</div>
